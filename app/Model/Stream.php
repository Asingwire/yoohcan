	...
	var $validationSets = array(
		'front_add' => array(
			...
			'alphaNumeric' => array(
                'rule' => 'alphaNumeric',
                //'required' => true,
                'message' => 'Enter Letters and numbers only for stream key'
            ),
			),'encoding_profile' => array(
			'notempty' => array(
				'rule' => array('notempty'),
				'message' => 'Encoding profile cannot be empty',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
                ...
                'naturalNumber' => array(
                    'rule' => 'naturalNumber',
                    'message' => 'Timeshift should be a Natural number',
                    'allowEmpty' => true
                ),'number' => array(
                    'rule' => array('range', 60, 3600),
                    'message' => 'Timeshift should be a number between 60 and 3600'
                )
            ),'live_edge_offset' => array(
                'naturalNumber' => array(
                    'rule' => array('naturalNumber', true),
                    'message' => 'Live Edge Offset should be a Natural number',
                    'allowEmpty' => true
                ),'number' => array(
                    'rule' => array('range', 0, 172800),
                    'message' => 'Live Edge Offset can be any number from 0 to 172800'
                )
            ),/*'time_zone' => array(
                'notEmpty' => array(
                    'rule' => 'notEmpty',
