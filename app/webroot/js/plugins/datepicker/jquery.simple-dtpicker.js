 ...
 (function($) {
	...
	**/
	...
	var draw = function($picker, option, year, month, day, hour, min) {
		...
		//changed by pankaj verma on 10-08-2014 for change calendar header format YYYY-MM  to MM-YYYY
		
		//$now_month.text(date.getFullYear() + " " + translate(locale, 'sep') + " " + translate(locale, 'months')[date.getMonth()]);
		
		$now_month.text(translate(locale, 'months')[date.getMonth()] + " " + translate(locale, 'sep') + " " + date.getFullYear());
